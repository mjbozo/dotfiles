...
-- Displays which-key popup sooner (this is a filthy lie, use the `delay` option for which-key instead)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          mappings = {
            i = {
              -- Map enter to open file in new tab
      ...
      end, { desc = 'Float [e]rrors' })
      vim.keymap.set('n', '<leader><leader>', '<esc>', { desc = 'Close' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Go to type definition of variable under cursor
...
-- Keybinds for sane people (aka i want helix back)
vim.keymap.set({ 'n', 'v' }, 'gh', '0', { desc = 'Move to start of line' })
vim.keymap.set({ 'n', 'v' }, 'gs', '^', { desc = 'Move to start character of line' })
vim.keymap.set({ 'n', 'v' }, 'gl', '$', { desc = 'Move to end of line' })
vim.keymap.set({ 'n', 'v' }, 'ge', 'G', { desc = 'Move to end of file' })
vim.keymap.set('v', 'V', '$j', { desc = 'Extend selection to next line' })
vim.keymap.set('n', '<C-n>', ':tabp<cr>')
vim.keymap.set('n', '<C-l>', ':tabn<cr>')
vim.keymap.set('n', '<C-j>', 'Vdp')
vim.keymap.set('n', '<C-k>', 'VdkP')
vim.keymap.set({ 'n', 'v' }, '(', 'xi()<esc>P', { desc = 'Match parentheses ()' })
vim.keymap.set({ 'n', 'v' }, '"', 'xi""<esc>P', { desc = 'Match quotations ""' })
vim.keymap.set({ 'n', 'v' }, '[', 'xi[]<esc>P', { desc = 'Match backets []' })
vim.keymap.set({ 'n', 'v' }, '{', 'xi{}<esc>P', { desc = 'Match squirlies {}' })
vim.keymap.set('n', '<C-_>', function()
  vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('Vgc', true, false, true), 'v', false)
end, { desc = 'Comment', noremap = true, silent = true })
vim.keymap.set('v', '<C-_>', function()
  vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('gc', true, false, true), 'v', false)
end, { desc = 'Comment', noremap = true, silent = true })
...
vim.api.nvim_create_user_command('O', function(opts)
  local cmdArg = 'tabnew ' .. (opts.fargs[1] or '')
  vim.cmd(cmdArg)
